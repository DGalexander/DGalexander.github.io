...
Tweets returned are cleaned (4000 observations) based on following perameters (which provide 1125 
observations):
...
From the observations, it is clear the basic sentiment analysis is 
