...
To do this we will use the [leaflet for R](https://rstudio.github.io/leaflet/) package. The new beta site from the [Office for National Statistics Open Geography Portal](http://opengeography.ons.opendata.arcgis.com/) ESRI Arc GIS 
