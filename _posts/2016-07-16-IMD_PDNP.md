...
*Further updates could include extra layers; the National Park boundary from magic.gov.uk, weighted polygons from [http://opengeography.ons.opendata.arcgis.com/](http://opengeography.ons.opendata.arcgis.com/) and the 2010 data.
